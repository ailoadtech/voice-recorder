...
ATTENTION:
This application is fully KI generated by Kiro.dev and is a test project part of a hackathon only to test code quality and output.
I dont use it and havn't tested it in much detail. There are bugs and i will not fix them. Feel free to use the code.

## Features

- 🎤 Voice recording with hotkey activation
- 📝 AI-powered transcription using Whisper
- ✨ Text enrichment using GPT models
...
- 🌐 Flexible - Run locally or on a remote server
...
**Next Steps:**
- ⏭️ Configure Tauri desktop runtime (Phase 1.2)
- ⏭️ Implement audio recording (Phase 2)
- ⏭️ Add transcription service (Phase 4)
